...
from mxcubecore.HardwareObjects.abstract.AbstractDiffractometer import DiffractometerHead
...
class MICROMAXCollect(AbstractCollect, HardwareObject):
    ...
    def take_crystal_snapshots(self):
        ...
        if self.current_dc_parameters["take_snapshots"]:
            ...
            if self.diffractometer_hwobj.head_type == DiffractometerHead.PLATE.value:
