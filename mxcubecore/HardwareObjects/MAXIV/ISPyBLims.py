...
class CustomISPyBDataAdapter(ISPyBDataAdapter):
    ...
    def _get_sessions(self, username: str, beamline_name: str):
        for proposal in self._get_proposals(username):
            ...
            #
            if len(sessions) == 0:
                yield _create_session_object(proposal, LAZY_SESSION_ID, beamline_name)
